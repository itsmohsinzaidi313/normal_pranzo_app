...
import 'package:normalpranzoapp/pages/register_page.dart';
...
class LoginView extends StatefulWidget {
  ...
  @override
  _LoginViewState createState() => _LoginViewState(products: list);
}
                                ...
                                if (formKey.currentState.validate()) {
                                  ...
                                  jsonManipulator
                                    ...
                                    if (status) {
                                      ...
                                      postOrder.customerName = customer.name;
                                      ...
                                      postOrder.total = getTotalPrice(products);
